...
import com.wanhao.wms.ui.function.enter.OtherEnterGoodsPresenter;
...
public class OtherOrderPresenter extends DefaultDocPresenter{
    ...
    public void loadData() {
        ...
        OkHttpHeader.post(UrlApi.other_order_out, mParams, new BaseResultCallback() {
            @Override
    ...
    public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
        ...
        GoodsLIstActivity.putPresenter(OtherOperatePresenter.class, bundle);
        OtherOperatePresenter.putDoc(iDoc, bundle);
