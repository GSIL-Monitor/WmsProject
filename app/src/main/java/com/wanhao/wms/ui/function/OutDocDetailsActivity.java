...
public class OutDocDetailsActivity extends BaseActivity {
    ...
    private OutOrderBean purchaseOrder;
    private String url;

    public static void put(OutOrderBean purchaseOrder, Bundle bundle) {
    ...
    public void initData() {
        super.initData();
        purchaseOrder = C.sGson.fromJson(getBundle().getString("a"), OutOrderBean.class);
    ...
    public void initWidget() {
        super.initWidget();
        mDocNoTv.setText(String.valueOf(purchaseOrder.getSoCode()));
    ...
    private void loadData() {
        mParams.put("soCode", purchaseOrder.getSoCode());
