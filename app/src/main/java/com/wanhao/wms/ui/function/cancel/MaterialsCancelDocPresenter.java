...
public class MaterialsCancelDocPresenter extends DefaultDocPresenter{
    ...
    public void loadData() {
        ...
        OkHttpHeader.post(UrlApi.materials_cancel_order, mParams, new BaseResultCallback() {
            @Override
    ...
    public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
        ...
        GoodsLIstActivity.putPresenter(MaterialsCancelOperatePresenter.class, bundle);
        MaterialsCancelOperatePresenter.putDoc(iDoc, bundle);
