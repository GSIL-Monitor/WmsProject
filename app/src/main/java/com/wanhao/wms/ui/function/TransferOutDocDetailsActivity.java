...
public class TransferOutDocDetailsActivity extends BaseActivity {
    ...
    public void initData() {
        super.initData();
        purchaseOrder = C.sGson.fromJson(getBundle().getString("a"), TransferOutOrderBean.class);
    ...
    public void initWidget() {
        super.initWidget();
        mDocNoTv.setText(String.valueOf(purchaseOrder.getTransCode()));
    ...
    private void loadData() {
        ...
        OkHttpHeader.post(url, mParams, new BaseResultCallback() {
            ...
            protected void onResult(BaseResult resultObj, int id) {
                cancelLoadingDialog();
                ArrayList<TransferOutDetailsBean> list = resultObj.getList(TransferOutDetailsBean.class);
                if (list != null) {
                    mGoods.addAll(list);
                }
