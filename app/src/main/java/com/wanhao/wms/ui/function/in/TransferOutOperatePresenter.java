...
public class TransferOutOperatePresenter extends DefaultGoodsListPresenter {
    ...
    DecodeCallback callback = new DecodeCallback(MarkRules.RACK_MARK_CODE, MarkRules.GOODS_MARK_CODE) {
        ...
        public void onGoodsCode(IGoodsDecode data) {
            ...
            boolean isHas = false;
            for (TransferOutDetailsBean d : mGoodsAll) {
    ...
    private void addGoods(TransferOutDetailsBean g, IGoodsDecode goods) {
        boolean add = false;
        ...
        TransferOutDetailsBean clone = (TransferOutDetailsBean) g.clone();
    ...
    public void actionSubmit() {
        ...
        for (IDoc iDoc : mGoodsList) {
            ...
            map.put("transCode", pd.getTransCode());
