 ...
 * @author ql
 */
@BindPresenter(titleRes = R.string.enter_storage)
public class EnterStoragePresenter extends DefaultDocPresenter {
    ...
    public void loadData() {
        ...
        OkHttpHeader.post(UrlApi.purchaseOrder, mParams, new BaseResultCallback() {
            @Override
