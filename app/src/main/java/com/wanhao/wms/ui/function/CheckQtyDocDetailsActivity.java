...
import com.wanhao.wms.bean.CheckQtyDetails;
...
public class CheckQtyDocDetailsActivity extends BaseActivity {
    ...
    private CheckQtyDoc purchaseOrder;
    private String url;

    public static void put(CheckQtyDoc purchaseOrder, Bundle bundle) {
    ...
    public void initData() {
        super.initData();
        purchaseOrder = C.sGson.fromJson(getBundle().getString("a"), CheckQtyDoc.class);
    ...
    public void initWidget() {
        super.initWidget();
        mDocNoTv.setText(String.valueOf(purchaseOrder.getInventoryCode()));
    ...
    private void loadData() {
        mParams.put("inventoryCode", purchaseOrder.getInventoryCode());
        ...
        OkHttpHeader.post(url, mParams, new BaseResultCallback() {
            ...
            protected void onResult(BaseResult resultObj, int id) {
                cancelLoadingDialog();
                ArrayList<CheckQtyDetails> list = resultObj.getList(CheckQtyDetails.class);
                if (list != null) {
                    mGoods.addAll(list);
                }
