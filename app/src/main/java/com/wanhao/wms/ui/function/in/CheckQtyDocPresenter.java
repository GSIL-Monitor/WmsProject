...
public class CheckQtyDocPresenter  extends DefaultDocPresenter{
    ...
    public void init(Bundle bundle) {
        mParams.put("whCode", WarehouseBean.getSelectWarehouse().getWhCode());
        super.init(bundle);
    ...
    public void loadData() {
        ...
        OkHttpHeader.post(UrlApi.check_qty_order, mParams, new BaseResultCallback() {
            @Override
            ...
            protected void onResult(BaseResult resultObj, int id) {
                ...
                ArrayList<CheckQtyDoc> list = resultObj.getList(CheckQtyDoc.class);
                if (list != null) {
                    mDocs.addAll(list);
                }
    ...
    public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
        CheckQtyDoc iDoc = (CheckQtyDoc) mDocs.get(position);
        Bundle bundle = getBundle();
        GoodsLIstActivity.putPresenter(CheckQtyOperatePresenter.class, bundle);
        CheckQtyOperatePresenter.putDoc(iDoc, bundle);
