...
public class SalesCancelOperatePresenter extends DefaultGoodsListPresenter {
    ...
    public void actionSubmit() {
        ...
        OkHttpHeader.post(UrlApi.sales_cancel_submit, params, new BaseResultCallback() {
    ...
    public void actionDocDetails() {
        ...
        EnterDocDetailsActivity.putLoadUrl(UrlApi.sales_cancel_order_details, bundle);
