...
public class SalesOrderPresenter extends DefaultDocPresenter{
    ...
    public void loadData() {
        ...
        OkHttpHeader.post(UrlApi.sales_order, mParams, new BaseResultCallback() {
            @Override
    ...
    public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
        ...
        GoodsLIstActivity.putPresenter(SalesOperatePresenter.class, bundle);
        SalesOperatePresenter.putDoc(iDoc, bundle);
