...
public class OtherEnterGoodsPresenter extends DefaultGoodsListPresenter {
    ...
    private void loadDocGoods() {
        ...
        OkHttpHeader.post(UrlApi.other_enter_details, mParams, new BaseResultCallback() {
            @Override
    ...
    public void actionDocDetails() {
        ...
        EnterDocDetailsActivity.putLoadUrl(UrlApi.other_enter_details, bundle);
    ...
    public void actionSubmit() {
        ...
        OkHttpHeader.post(UrlApi.other_enter_details_submit, params, new BaseResultCallback() {
            @Override
            public void onBefore(Request request, int id) {
                super.onBefore(request, id);
                iDialog.cancelLoadingDialog();
