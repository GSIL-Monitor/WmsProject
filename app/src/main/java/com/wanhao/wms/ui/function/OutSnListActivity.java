...
public class OutSnListActivity extends BaseActivity implements BaseQuickAdapter.OnItemChildClickListener {
    ...
    private OutOrderDetails mGoods;
    private int id;
    ...
    public static void put(List<Sn> mSnList, OutOrderDetails outOrderDetails, Bundle bundle) {
        outOrderDetails.setLabels(null);
        bundle.putString(GOODS, JsonUtils.toJson(outOrderDetails));
    ...
    public void initData() {
        ...
        mGoods = JsonUtils.fromJson(getBundle().getString(GOODS), OutOrderDetails.class);
