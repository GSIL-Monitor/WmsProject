...
public class PickingBoxDetailsActivity extends BaseActivity {
    ...
    private BoxOrder purchaseOrder;
    private String url;

    public static void put(BoxOrder purchaseOrder, Bundle bundle) {
    ...
    public void initData() {
        super.initData();
        purchaseOrder = C.sGson.fromJson(getBundle().getString("a"), BoxOrder.class);
    ...
    public void initWidget() {
        super.initWidget();
        mDocNoTv.setText(String.valueOf(purchaseOrder.getPlCode()));
    ...
    private void loadData() {
        mParams.put("plCode", purchaseOrder.getPlCode());
        ...
        OkHttpHeader.post(url, mParams, new BaseResultCallback() {
            ...
            protected void onResult(BaseResult resultObj, int id) {
                cancelLoadingDialog();
                ArrayList<BoxDetails> list = resultObj.getList(BoxDetails.class);
                if (list != null) {
                    mGoods.addAll(list);
                }
