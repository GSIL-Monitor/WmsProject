 ...
 * @author ql
 */
@BindPresenter(titleRes = R.string.storage_cancel)
public class StorageCancelOperatePresenter extends DefaultGoodsListPresenter {
    ...
    private void loadDocGoods() {
        ...
        OkHttpHeader.post(UrlApi.sales_cancel_order_details, mParams, new BaseResultCallback() {
    ...
    public void actionSubmit() {
        ...
        OkHttpHeader.post(UrlApi.storage_cancel_submit, params, new BaseResultCallback() {
    ...
    public void actionDocDetails() {
        ...
        OutDocDetailsActivity.putLoadUrl(UrlApi.storage_cancel_order_details, bundle);
