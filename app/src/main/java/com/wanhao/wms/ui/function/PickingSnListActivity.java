...
public class PickingSnListActivity extends BaseActivity implements BaseQuickAdapter.OnItemChildClickListener {
    ...
    private PickingOrderDetails mGoods;
    private int id;
    ...
    public static void put(List<Sn> mSnList, PickingOrderDetails PickingOrderDetails, Bundle bundle) {
        PickingOrderDetails.setLabels(null);
        bundle.putString(GOODS, JsonUtils.toJson(PickingOrderDetails));
    ...
    public void initData() {
        ...
        mGoods = JsonUtils.fromJson(getBundle().getString(GOODS), PickingOrderDetails.class);
