...
public class RackUpDocPresenter extends DefaultDocPresenter{
    ...
    public void loadData() {
        ...
        OkHttpHeader.post(UrlApi.rack_up_order, mParams, new BaseResultCallback() {
            @Override
    ...
    public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
        ...
        GoodsLIstActivity.putPresenter(RackUpOperatePresenter.class, bundle);
        RackUpOperatePresenter.putDoc(iDoc, bundle);
