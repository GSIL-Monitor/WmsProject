...
public class TransferOutDocPresenter extends DefaultDocPresenter{
    ...
    public void loadData() {
        ...
        OkHttpHeader.post(UrlApi.transfer_out_order, mParams, new BaseResultCallback() {
            ...
            protected void onResult(BaseResult resultObj, int id) {
                ...
                ArrayList<TransferOutOrderBean> list = resultObj.getList(TransferOutOrderBean.class);
                if (list != null) {
                    mDocs.addAll(list);
                }
    ...
    public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
        TransferOutOrderBean iDoc = (TransferOutOrderBean) mDocs.get(position);
        Bundle bundle = getBundle();
        GoodsLIstActivity.putPresenter(TransferOutOperatePresenter.class, bundle);
        TransferOutOperatePresenter.putDoc(iDoc, bundle);
