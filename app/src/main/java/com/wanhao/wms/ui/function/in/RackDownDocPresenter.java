...
import com.wanhao.wms.ui.function.enter.EnterStorageGoodsPresenter;
...
@BindPresenter(titleRes = R.string.rack_down)
public class RackDownDocPresenter extends DefaultDocPresenter{
    ...
    public void loadData() {
        ...
        OkHttpHeader.post(UrlApi.rack_down_order, mParams, new BaseResultCallback() {
            @Override
            ...
            protected void onResult(BaseResult resultObj, int id) {
                ...
                ArrayList<RackDownOrderBean> list = resultObj.getList(RackDownOrderBean.class);
                if (list != null) {
                    mDocs.addAll(list);
                }
    ...
    public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
        RackDownOrderBean iDoc = (RackDownOrderBean) mDocs.get(position);
        Bundle bundle = getBundle();
        GoodsLIstActivity.putPresenter(RackDownOperatePresenter.class, bundle);
        RackDownOperatePresenter.putDoc(iDoc, bundle);
