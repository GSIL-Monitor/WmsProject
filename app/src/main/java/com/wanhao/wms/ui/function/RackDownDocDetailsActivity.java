...
public class RackDownDocDetailsActivity extends BaseActivity {
    ...
    private RackDownOrderBean purchaseOrder;
    private String url;

    public static void put(RackDownOrderBean purchaseOrder, Bundle bundle) {
    ...
    public void initData() {
        super.initData();
        purchaseOrder = C.sGson.fromJson(getBundle().getString("a"), RackDownOrderBean.class);
    ...
    public void initWidget() {
        super.initWidget();
        mDocNoTv.setText(String.valueOf(purchaseOrder.getAdjustCode()));
    ...
    private void loadData() {
        mParams.put("adjustCode", purchaseOrder.getAdjustCode());
        ...
        OkHttpHeader.post(url, mParams, new BaseResultCallback() {
            ...
            protected void onResult(BaseResult resultObj, int id) {
                cancelLoadingDialog();
                ArrayList<RackDownDetailsBean> list = resultObj.getList(RackDownDetailsBean.class);
                if (list != null) {
                    mGoods.addAll(list);
                }
