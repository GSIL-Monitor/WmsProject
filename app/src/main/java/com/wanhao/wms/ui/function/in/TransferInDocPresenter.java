...
public class TransferInDocPresenter extends DefaultDocPresenter{
    ...
    public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
        ...
        GoodsLIstActivity.putPresenter(TransferInOperatePresenter.class, bundle);
        TransferInOperatePresenter.putDoc(iDoc, bundle);
