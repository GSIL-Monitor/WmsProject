...
public class StorageCancelOrderPresenter extends DefaultDocPresenter{
    ...
    public void loadData() {
        ...
        OkHttpHeader.post(UrlApi.storage_cancel_order, mParams, new BaseResultCallback() {
            @Override
    ...
    public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
        ...
        GoodsLIstActivity.putPresenter(StorageCancelOperatePresenter.class, bundle);
        StorageCancelOperatePresenter.putDoc(iDoc, bundle);
