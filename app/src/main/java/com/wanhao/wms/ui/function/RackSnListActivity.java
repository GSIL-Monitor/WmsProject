...
public class RackSnListActivity extends BaseActivity implements BaseQuickAdapter.OnItemChildClickListener {
    ...
    private RackDownDetailsBean mGoods;
    private int id;
    ...
    public static void put(List<Sn> mSnList, RackDownDetailsBean purchaseOrderDetails, Bundle bundle) {
    ...
    public void initData() {
        ...
        mGoods = JsonUtils.fromJson(getBundle().getString(GOODS), RackDownDetailsBean.class);
